...
class RainTPL {
   ...
   protected function compileFile($tpl_basename, $tpl_basedir, $tpl_filename, $cache_dir, $compiled_filename) {
      ...
      if (!is_writable($cache_dir))
         throw new RainTpl_Exception('Cache directory ' . $cache_dir . 'doesn\'t have write permission.'
                 . ' Set write permission or set RAINTPL_CHECK_TEMPLATE_UPDATE to false.'
                 . ' More details on http://www.raintpl.com/Documentation/Documentation-for-PHP-developers/Configuration/');
...
<html>
   ...
   <body>
      ...
      <p>
         ...
         <a target="_blank" href="https://facturascripts.com">la comunidad FacturaScripts</a>
         está para ayudarte.
      </p>
   </body>
</html>
