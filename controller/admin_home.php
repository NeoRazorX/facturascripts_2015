...
class admin_home extends fs_controller
{
   ...
   private function get_download_list()
   {
      ...
      if(!$this->download_list2)
      {
         ...
         {
            $this->new_error_msg('Error al descargar la lista de plugins, talvez necesitas configurar un Servidor Proxy en <a href="#t_avanzado" aria-controls="t_avanzado" role="tab" data-toggle="tab"></i><span class="fa fa-wrench"></span>&nbsp;Avanzado</a>.');
